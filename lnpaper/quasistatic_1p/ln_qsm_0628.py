...
import argparse
parser = argparse.ArgumentParser(description='fmaxscan')
parser.add_argument('-b_fmax','--b_fmaxfmax', help='bandwidth', required=True, type=float)
parser.add_argument('-nr','--nrun_times', help='Variation in Rydberg Coupling Strength', required=True, type=int)
args = vars(parser.parse_args())
b_fmax = args["b_fmaxfmax"]
nrun=args["nrun_times"]

#nrun=100
num_cores=32

tpnum=2
filestr="fmaxswp_0628_"+str(b_fmax)+".txt"
f=open(filestr,"w")
