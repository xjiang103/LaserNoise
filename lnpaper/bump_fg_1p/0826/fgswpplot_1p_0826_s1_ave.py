...
filestr="sig_0826_s1_1.txt"
f=open(filestr,"r")
filestr2="sig_0826_s1m_1.txt"
fm=open(filestr2,"r")
xa=[]
ya=[]
ta=[]
...
tpi=2
filestr="sig_0826_s1_2.txt"
f=open(filestr,"r")
filestr2="sig_0826_s1m_2.txt"
fm=open(filestr2,"r")
xa=[]
ya=[]
ta=[]
...
plt.savefig('x_ave_sig.pdf', bbox_inches='tight')
