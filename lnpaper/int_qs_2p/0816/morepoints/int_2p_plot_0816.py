...
plt.yscale('log')
plt.text(0.01, 0.04, 'a', horizontalalignment='center',
...
#plt.legend(loc="lower right", prop={'size': 10})
plt.yscale('log')
plt.text(0.01, 0.015, 'c', horizontalalignment='center',
     verticalalignment='center')
f.close()
...
plt.yscale('log')
plt.text(0.01, 0.02, 'd', horizontalalignment='center',
     verticalalignment='center')
f.close()
