...
parser.add_argument('-bw','--bw_number', help='bw_number', required=True, type=int)
args = vars(parser.parse_args())
tpi_num = args["tpi_number"]
bw_num=args["bw_number"]

num_cores=64
nrun=30
units=1e6
filestr="h03swp"+str(tpi_num)+"_"+str(bw_num)+"_0321.txt"
f=open(filestr,"w")
print(filestr)
avenum=1
