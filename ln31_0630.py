...
##parser.add_argument('-nrun','--n_run_times', help='Number of Averages', required=True, type=float)
...
###plt.yscale("log")
###plt.xscale("log")
##plt.title("Error at time=π/Ω, sweeping fg")
##plt.show()
